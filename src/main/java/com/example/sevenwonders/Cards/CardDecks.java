...
public class CardDecks {
     ...
     */
    public static List<CardTypeQuantity> deckCardQuantities_Gizeh = Arrays.asList(// material
     ...
     */
    public static List<CardTypeQuantity> deckCardQuantities_Rhodes = Arrays.asList(// material
            new CardTypeQuantity(2, CardType.CardMaterialWood), //
            new CardTypeQuantity(2, CardType.CardMaterialPaper), //
     ...
     */
    public static List<CardTypeQuantity> deckCardQuantities_Babylon = Arrays.asList(// material
            new CardTypeQuantity(2, CardType.CardMaterialWood), //
            new CardTypeQuantity(2, CardType.CardMaterialPaper), //
     ...
     */
    public static List<CardTypeQuantity> deckCardQuantities_Halicarnasse = Arrays.asList(// material
            new CardTypeQuantity(2, CardType.CardMaterialWood), //
     ...
     */
    public static List<CardTypeQuantity> deckCardQuantities_Alexandrie = Arrays.asList(// material
            new CardTypeQuantity(2, CardType.CardMaterialWood), //
            new CardTypeQuantity(2, CardType.CardMaterialPaper), //
            new CardTypeQuantity(2, CardType.CardMaterialBrick), //
            new CardTypeQuantity(2, CardType.CardMaterialStone), //
     ...
     */
    public static List<CardTypeQuantity> deckCardQuantities_Ephese = Arrays.asList(// material
            new CardTypeQuantity(2, CardType.CardMaterialWood), //
            new CardTypeQuantity(2, CardType.CardMaterialPaper), //
            new CardTypeQuantity(2, CardType.CardMaterialBrick), //
            new CardTypeQuantity(2, CardType.CardMaterialStone), //
     ...
     */
    public static List<CardTypeQuantity> deckCardQuantities_Olympie = Arrays.asList(// material
     ...
     */
    public static List<CardTypeQuantity> deckCardQuantities_Extra = Arrays.asList(// material
