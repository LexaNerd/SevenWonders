...
import java.util.List;
  ...
  public enum ProgressToken {
    ...
    Propaganda("propaganda", "propagande", //
            "Lorsque vous prenez une carte Rouge avec 1 ou 2 icénes 'corne', " //
                    + "choisissez 1 carte supplémentaire parmi les 3 disponibles et posez-la devant vous", //
    ...
    Economy("economy", "économie", //
            "1 carte jaune en votre possession vous offre 2 piéces au lieu d'une seule", //
            "token-economy.png"),
    ...
    Tactic("tactic", "tactique", //
            "Ajoutez 2 Boucliers é votre total de Boucliers", //
            "token-tactic.png"),
    ...
    Politic("politic", "politique", //
            "A la fin de la partie, " //
                    + "gagnez 1 Point de victoire par écone 'chat', présente sur vos cartes bleues", //
            "token-politic.png"),
    ...
    Education("education", "éducation", //
            "A la fin de la partie, " //
                    + "gagnez 2 Points de victoire par jeton de Progrés en votre possession (celui-ci y compris)", //
            "token-green-token2.png"),
    ...
    Culture("culture", "culture", //
            ...
            "token-culture.png"),
    Culture2("culture", "culture", //
            "Ce jeton est présent en 2 exemplaires. A la fin de la partie, " //
                    + " gagnez 4 Points de victoire si vous possédez 1, ou 12 Points de victoire si vous possédez les 2", //
            "token-culture.png"),

    aucun(null, null, null, null);
    ...
    public static ProgressToken[] initialisation() {
        ProgressToken[] listeTokenAvaible = ProgressToken.values();
        List<ProgressToken> tokens = new ArrayList<>(Arrays.asList(listeTokenAvaible));

        tokens.removeIf(token -> token.displayName == null || token.displayName.equals(""));

        return tokens.toArray(new ProgressToken[0]);
    }
